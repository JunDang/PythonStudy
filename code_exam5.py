...
class edx(object):
    def __init__(self, courseNames):
        self.myCourses = []
        for courseName in coursNames:
            self.myCourses.append(courseInfo(courseName))

    def setGrade(self, grade, courseName="6.01x"):
        """
    ...
    def getGrade(self, courseName="6.02x"):
        """
        course: string 
